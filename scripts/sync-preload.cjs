/**
 * Electron loads desktop/preload.cjs (CommonJS).
 * Source of truth for the API surface: src/desktop/preload.ts
 */
const fs = require("node:fs");
const path = require("node:path");

const target = path.join(__dirname, "..", "desktop", "preload.cjs");
...
console.log("Synced desktop/preload.cjs");
